                ...
                <table v-show="this.assetsNoLimit.length != 0">
                    <tbody>
                        ...
                        >
                            ...
                            <td class="table__col--right table__col--cost">{{this.format(asset.cost)}}</td>
                            <td class="table__col--right tabel__col--depreciation">{{this.format(asset.depreciation_rate/100 * asset.cost)}}</td>
                            <td class="table__col--right table__col--residual">{{this.format((asset.cost - (asset.depreciation_rate/100 * asset.cost)) < 0 ? 0 : asset.cost - (asset.depreciation_rate/100 * asset.cost))}}</td>
                        ...
                        <tr class="table__row--paging">
                            <td class="table__col--assetname" colspan="4">
                                <div class="table__pagination">
                                    <div class="table__sum">Tổng số: <b>{{format(this.totalAllAssets)}} bản ghi</b></div>
                ...
                <div class="modal__line">
                    <div class="modal__item">
                        ...
                        <div class="modal__input--icon" 
                            @keydown.enter = "(this.department.showModal = !this.department.showModal)"
                            @submit.prevent="onSubmit"
